...
public class EmployeeConfig {
	...
	CommandLineRunner commandLineRunner(EmployeeRepository data) {
		return args -> {
			Employee emp = new Employee(1L, "marmar1234", "Marius", "Marthinussen", "890519-XXXX", "Marius@gmail.com",
					"12345678", "Södra Vägen", "44556", "Göteborg", "developer", "volvo", LocalDate.of(2000, 1, 1));
			Employee emp2 = new Employee("nadham4321", "Nadia", "Hamid", "900519-XXXX", "Naida@gmail.com", "87654321",
