	...
	CommandLineRunner commandLineRunner(EmployeeRepository data) {
		return args -> {
			Employee emp = new Employee("Marius", "Marthinussen", "890519-XXXX", "Marius@gmail.com", "12345678",
					...
					EmployeeStatus.ACTIVE, SystemStatus.USER);
			Employee emp2 = new Employee("Nadia", "Hamid", "900519-XXXX", "Nadia@gmail.com", "87654321", "Norra Vägen",
					"44556", "Göteborg", "developer", "saab", LocalDate.of(2005, 1, 1), null, EmployeeStatus.VACATION,
